...
//--------------------------------------------------------------------------------------------------
	q3Quaternion::q3Quaternion(const Vec3 &axis, float radians)
	{
		Set(axis, radians);
	}

//--------------------------------------------------------------------------------------------------
	void q3Quaternion::Set(const Vec3 &axis, float radians)
	{
...
//--------------------------------------------------------------------------------------------------
	void q3Quaternion::ToAxisAngle(Vec3 *axis, float *angle) const
	{
		assert(w <= float(1.0));
...
//--------------------------------------------------------------------------------------------------
	void q3Quaternion::Integrate(const Vec3 &dv, float dt)
	{
...
//--------------------------------------------------------------------------------------------------
	const q3Mat3 q3Quaternion::ToMat3(void) const
	{
		...
		return q3Mat3(
				Vec3(float(1.0) - qyqy2 - qzqz2, qxqy2 + qzqw2, qxqz2 - qyqw2),
				Vec3(qxqy2 - qzqw2, float(1.0) - qxqx2 - qzqz2, qyqz2 + qxqw2),
				Vec3(qxqz2 + qyqw2, qyqz2 - qxqw2, float(1.0) - qxqx2 - qyqy2)
		);
	}
}